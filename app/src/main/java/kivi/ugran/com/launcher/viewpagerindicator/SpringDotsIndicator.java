...
import static kivi.ugran.com.launcher.viewpagerindicator.ThemeUtils.getThemePrimaryColor;
...
public class SpringDotsIndicator extends FrameLayout {
  ...
  private ViewGroup buildDot(boolean stroke) {
    ViewGroup dot = (ViewGroup) LayoutInflater.from(getContext()).inflate(R.layout.dot_spring_layout, this, false);
